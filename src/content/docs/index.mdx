...
hero:
  tagline: Sistema Inteligente Procesos Investigativos de Unitrópico!
  image:
    file: ../../assets/logo-simbolo-unitropico.png
  actions:
    - text: Ver Manual de Usuario
      link: /manual_usuario_investigacion/modulos/grupos_investigacion/
      icon: right-arrow
---
